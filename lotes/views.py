...
class Index(APIView):
    def get(self, request):
        try:
            ...
            return Response(
                "message:error: pagina nao encontrada", status=status.HTTP_404_NOT_FOUND
            )
...
class PagamentoListCreateView(generics.CreateAPIView):
    ...
    def get(self, request):
        try:
            ...
            print(e)
            return Response(
                {"message": "Erro ao processar a solicitação.", "error": str(e)},
...
class PagamentoRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "pagamento  não encontrado.", status=status.HTTP_404_NOT_FOUND
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "Informacoes do pagamento  actualizadas com sucesso!",
    ...
    def delete(self, request, pk):
        ...
        return Response(
            "pagamento excluido com sucesso", status=status.HTTP_204_NO_CONTENT
        )
    ...
    def get(self, request):
        try:
            ...
            serializer = self.serializer_class(
                self.queryset[start_num:end_num], many=True
            )
            loteobj = serializer.data

            for item in loteobj:
                # if item["documento"] :
                item["imagem"] = request.build_absolute_uri(item["imagem"])
                
            # item["link_publico"] = get_public_link(item['codigoLote'])
    ...
    def post(self, request):
        try:
            ...
            if "codigoLote" not in request.data or not request.data["codigoLote"]:
                ...
                request.data["codigoLote"] = generate_random_identifier()
...
class LoteRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, *args, pk):
        try:
            ...
            return Response(
                {"message": "Lote não encontrado."}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                f"Lote com número {loteid} não encontrado.",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                f"Informacoes do lote n {loteid} actualizadas com sucesso!",
                status=status.HTTP_200_OK,
            )
        else:
            return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def delete(self, request, pk):
        ...
        try:
            ...
            return Response(
                f"Lote com o Identificador: {loteid} não encontrado.",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        return Response(
            f"lote com o identificador: {loteid} excluido com sucesso",
...
class TipoUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "Informacoes actualizadas com sucesso!", status=status.HTTP_200_OK
            )
...
class DescricaoCreateListView(generics.ListCreateAPIView):
    ...
    def post(self, request):
        try:
            ...
            return Response(
                {"message1": "Erro ao processar a solicitação.", "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class descricaoUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, *args, pk):
        try:
            ...
            return Response(
                {"message": "Descricao não encontrada."},
                status=status.HTTP_404_NOT_FOUND,
            )
...
class LocalizacaoLoteView(generics.ListCreateAPIView):
    ...
    def get(self, request):
        ...
        for item in serializer.data:
            if item["lote"]["imagem"]:
                item["lote"]["imagem"] = request.build_absolute_uri(
                    item["lote"]["imagem"]
                )
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(f"{serializer.data}", status=status.HTTP_202_ACCEPTED)
            else:
                return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)

        except Exception as e:
            return Response(
                {"message": "Erro ao processarao a solicitação.", "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class LocalizacaoLoteUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "Localizacao nao encontrada", status=status.HTTP_404_NOT_FOUND
            )
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"Lote Criado com sucesso"}, status=status.HTTP_202_ACCEPTED
                )
            else:
                return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class LoteSolicitacaoListCreateVier(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": "Erro ao recuperar os dados.", "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            link_publico = get_public_link(SolicitacaoInstance.loteId.codigoLote)
            print(link_publico)
            ...
            try:
                ...
                return Response(
                    {
                        f"message": "Solicitação feita com sucesso",
                        "Data": data,
                        "OBS Foi lhe enviado um Email para": request.user.email,
                    },
...
class LoteSolicitacaoRetrievDeleteUpdateView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk, *args):
        try:
            ...
            return Response(
                "A solicitacao nao existe", status=status.HTTP_404_NOT_FOUND
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "informacoes da solicitacao actualizadas com sucesso!",
    ...
    def delete(self, reuqest, pk):
        try:
            ...
            return Response(
                {"Nao existe nenhuma solicitacao"}, status=status.HTTP_404_NOT_FOUND
            )
...
class FinalidadeSolicitacaoListCrateView(generics.ListCreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                "Nao existem finalidades", status=status.HTTP_401_UNAUTHORIZED
            )
...
class FinalidadeSolicitacaoRetrieveView(generics.RetrieveAPIView):
    ...
    def retrieve(self, request, pk):
        try:
            ...
            return Response(
                f"Nao existe nehuma finalidade ", status=status.HTTP_404_NOT_FOUND
            )
        except Exception as e:
            print(e)
...
class FinalidadeSolicitacaoUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "A finalidade do lote com o id  nao existe",
                status=status.HTTP_404_NOT_FOUND,
            )
    ...
    def delete(self, request, pk):
        try:
            ...
            return Response(
                "finalidade do lote nao existe no sistema",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        return Response(
            "finalidade do lote  eliminda com sucesso!",
            status=status.HTTP_204_NO_CONTENT,
        )
...
class LoteAtribicaoListCreateView(generics.ListCreateAPIView):
    ...
    def get(self, request):
        try:
            ...
            return Response(
                {"Sao necessarias credenciais de usario"},
                status=status.HTTP_401_UNAUTHORIZED,
            )
    ...
    def post(self, request, *args, **kwargs):
        try:
            data = request.data
            idSolicitacao = request.data["id_solicitacao"]
            solicitacao = LoteSolicitacaoModel.objects.filter(id=idSolicitacao).get()
            statusAtribuicao = request.data["status"]
            AtribuicaoInstance = LoteAtribuicaoModel()
            AtribuicaoInstance.status = statusAtribuicao
            AtribuicaoInstance.id_solicitacao = solicitacao

            AtribuicaoInstance.save()

            Response_data = AtribuicaoInstance
            return Response(
                {"Atribuicao feita com sucesso!"}, status=status.HTTP_201_CREATED
            )
...
class LoteAtribuicaoUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, pk):
        try:
            ...
            return Response(
                "Nao existe atribuicao para este lote", status=status.HTTP_404_NOT_FOUND
            )
        except Exception as e:
            print(e)
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "A atribuicao do lote com o id  nao existe",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "Atribuicao do lote com o id  editada com sucesso",
                status=status.HTTP_202_ACCEPTED,
            )
    ...
    def delete(self, request, pk):
        try:
            ...
            return Response(
                "Atribuicao do lote nao existe no sistema",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        return Response(
            "Solicitacao do lote com o id  eliminda com sucesso!",
            status=status.HTTP_204_NO_CONTENT,
        )
...
class HistoricoLoteUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "O Historico do lote solicitado  nao existe",
                status=status.HTTP_404_NOT_FOUND,
            )
    ...
    def delete(self, request, pk):
        ...
        serializer.delete()
        return Response(
            "Historico do Lote Eliminado com Sucesso", status=status.HTTP_204_NO_CONTENT
        )
...
class LoteEmpresaRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, pk):
        try:
            ...
            return Response(
                "Nao existe uma empresa com este lote", status=status.HTTP_404_NOT_FOUND
            )
        except Exception as e:
            print(e)
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "Lote da Empresa  nao existe", status=status.HTTP_404_NOT_FOUND
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "Empresa Lote editada com sucesso", status=status.HTTP_202_ACCEPTED
            )
...
class LoteImageListCreateView(generics.ListCreateAPIView):
    ...
    def get(self, request):
        try:
            ...
            for item in serializer.data:
                if item["imagem"]:
                    item["imagem"] = request.build_absolute_uri(item["imagem"])
                    link_publico = get_public_link(item["titulo"])
                    data.append(
                        {
                            "id": str(item["id"]),
                            "titulo": item["titulo"],
    ...
    def post(self, request):
        try:
            ...
            loteData = LoteModel.objects.filter(id=lote).get()
            tituloLote = loteData.codigoLote
            loteImageInstance = Loteimage()
            loteImageInstance.titulo = tituloLote
            loteImageInstance.imagem = imagem
            loteImageInstance.lote = loteData
            loteImageInstance.save()

            response_data = self.uploadImagem(request)
    ...
    def uploadImagem(self, request):
        try:
            ...
            loteData = LoteModel.objects.filter(id=lote).get()
            tituloLote = loteData.codigoLote
            nome_imagem = tituloLote

            with NamedTemporaryFile(delete=False) as temp_file:
                for chunk in image_file.chunks():
                    temp_file.write(chunk)

            temp_file.close()  # Certifique-se de que o arquivo temporário foi fechado corretamente

            file_drive = drive.CreateFile({"title": nome_imagem})
            file_drive.SetContentFile(temp_file.name)
            file_drive.Upload()

            file_link = get_public_link(nome_imagem)

            return {"mensagem": "Upload bem-sucedido", "link_drive": file_link}
...
class LoteImagemRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, pk):
        try:
            titulo = self.queryset.filter(lote=pk)
            ...
            return Response(
                "Nao existe uma imagem associada a  lote",
                status=status.HTTP_404_NOT_FOUND,
            )
        except Exception as e:
            print(e)
    ...
    def put(self, request, pk):
        try:
            ...
            return Response(
                "Imagem do lote  nao existe", status=status.HTTP_404_NOT_FOUND
            )
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                "Imagem do Lote editada com sucesso", status=status.HTTP_202_ACCEPTED
            )
    ...
    def delete(self, request, pk):
        try:
            ...
            return Response(
                "Imagem do lote nao existe no banco de dados",
                status=status.HTTP_404_NOT_FOUND,
            )
        ...
        return Response(
            "imagem deletada com sucesso!", status=status.HTTP_204_NO_CONTENT
        )
...
class DocumentoTituloListcreateView(APIView):
    ...
    def get(self, request):
        try:
            ...
            print(e)
            return Response(
                {"message": "Erro ao Listar titulos de Documentos.", "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class DocumentoTitluoRetrieveDeleteUpdateView(APIView):
    ...
    def get(self, request, pk):
        try:
            ...
            print(e)
            return Response(
                {f"Erro ao Porocessar:", str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
        except DocumentoTituloModel.DoesNotExist:
            return Response(
                {"message": "Nome não encontrado."}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def put(self, request, pk):
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {
                        f"Informacoes do Documento  actualizadas com sucesso!": serializer.data
                    },
                    status=status.HTTP_200_OK,
                )
            else:
            ...
            return Response(
                "Documento  não encontrado.", status=status.HTTP_404_NOT_FOUND
            )
    ...
    def delete(self, request, pk):
        ...
        return Response(
            "documento excluido com sucesso", status=status.HTTP_204_NO_CONTENT
        )
        ...
        for localizacao in localizacoes:
            ...
            try:
                ...
                if distancia > 0 and duracao > 0:
                    ...
                    formatarDuracao = ""
                    if dia > 0:
                        formatarDuracao += f"{dia}d "
                    if hora > 0:
                        formatarDuracao += f"{hora}h e "
                    ...
                    if distancia > 1000:
                        localizacao_data["distancia"] = "{:.{}f}Km".format(
                            distanciaKm, 2
                        )
                        localizacao_data["velocidade"] = "{:.{}f}Km/h".format(
                            velocidadeKm, 2
                        )
                    if distancia < 1000:
                        localizacao_data["distancia"] = "{:.{}f}m".format(distancia, 2)
                        localizacao_data["velocidade"] = "{:.{}f}m/s".format(
                            (velocidadems), 5
                        )
                    ...
                    if sumario == "" or sumario == None:
                        localizacao_data[
                            "sumario"
                        ] = "Nao foi encontrado nenhum ponto de referencia"
                ...
                return Response(
                    {"error": f"Erro na solicitação à API do Mapbox: {str(e)}"},
                    status=status.HTTP_500_INTERNAL_SERVER_ERROR,
                )
